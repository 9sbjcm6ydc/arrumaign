...
!function (d, k, h) {
  XF.activate ? console.error('XF core has been double loaded')  : (XF.browser || (XF.browser = {
    ...
    d.addEventCapture = function () {
      ...
      return function (b) {
        h.addEventListener && ('string' == typeof b && (b = [
          b
    ...
    onWithin: function (a, b, c) {
      var e = this;
      d(h).on(a, function (a) {
        d(a.target).has(e).length && (c && d(h).off(a), b(a))
      });
      return this
    },
    ...
    onPassive: function (a, b) {
      ...
      if ('string' != typeof a || 'function' != typeof b) return console.warn('$.onPassive failure for %s.on%s, check parameters', this.get(0), a),
      this;
      if ( - 1 !== a.indexOf('.')) return console.warn('$.onPassive does not support namespaced events %s.on%s', this.get(0), a),
      !1;
    ...
    hasFixableParent: function () {
      ...
      this.parents().each(function () {
        ...
        if (b.data('sticky_kit')) return a = b,
        !1
      }); return a
    },
      ...
      this.parents().each(function () {
        ...
        switch (b.css('position')) {
          ...
          case '-webkit-sticky':
            ...
            f = b.css('top'),
            g = b.css('bottom');
            if ('auto' !== f && (f = c.top - e.top - parseInt(f, 10), 0.5 >= f && - 0.5 <= f) || 'auto' !== g && (f = c.bottom - e.bottom - parseInt(g, 10), 0.5 >=
            f && - 0.5 <= f)) return a = b,
            !1
        }
      }); return a
    ...
    normalizedScrollLeft: function (a) {
      ...
      switch (b) {
        case 'negative':
          return 0 > c ? - c : 0;
        case 'inverted':
          return b = a.scrollWidth - c - a.offsetWidth,
          0.5 > b ? 0 : b;
        default:
          return c
      }
    ...
    retinaFix: function () {
      if (2 <= k.devicePixelRatio) this.find('img[srcset]').one('load', function (a) {
  ...
  function () {
    function a(a) {
      ...
      b = 0;
      a && a.match(/^(\+|-|)([0-9]*\.[0-9]+|[0-9]+)(ms|s)/i) && (b = ('-' == RegExp.$1 ? - 1 : 1) * parseFloat(RegExp.$2) * ('ms' == RegExp.$3.toLowerCase() ? 1 : 1000));
      return b
    }
    function b(a, b, c) {
      var e = [
    ...
    function c(c, g, l, m, p) {
      ...
      k();
        ...
        if (c.css('transition-property').match(/(^|\s|,)-xf-(width|height)($|\s|,)/)) {
          ...
          q = c.data(z),
          v = n.style,
          y = v.transition || v['-webkit-transition'] || v['-moz-transition'] || v['-o-transition'] || '',
          u;
          if (void 0 === q) for (q = {
          }, u = 0; u < r.length; u++) q[r[u]] = v[r[u]] || '';
          if (0 == c[k]()) for (u in A = '0', B) B.hasOwnProperty(u) && (B[u] = '0');
          c.data(z, q).css('transition', 'none') [f](g);
          r = c.css(r);
          q = r[k];
          if (0 == c[k]()) for (u in q = '0', r) r.hasOwnProperty(u) && (r[u] = '0');
          c[h](g);
          if (A != q) {
            var C = m;
            c.css(B);
            n.offsetWidth;
            c.css('transition', y).css(r);
            m = function () {
  ...
  d.extend(XF, {
    ...
    onPageLoad: function () {
      ...
      d(h).on('keyup', 'a:not([href])', function (a) {
    ...
    updateAvatars: function (a, b, c) {
      d('.avatar').each(function () {
        ...
        if ((c || !f.hasClass('.js-croppedAvatar')) && f.is('[class^="' + g + '"]')) {
          ...
          e.html(f.html());
          f.hasClass('avatar--default') ? (e.addClass('avatar--default'), f.hasClass('avatar--default--dynamic') ? e.addClass('avatar--default--dynamic')  :
          f.hasClass('avatar--default--text') ? e.addClass('avatar--default--text')  : f.hasClass('avatar--default--image') && e.addClass('avatar--default--image'))  : e.removeClass('avatar--default avatar--default--dynamic avatar--default--text avatar--default--image');
    ...
    updateVisitorCounts: function (a, b, c) {
      a && 'public' == XF.getApp() && (XF.badgeCounterUpdate(d('.js-badge--conversations'), a.conversations_unread), XF.badgeCounterUpdate(d('.js-badge--alerts'), a.alerts_unread), XF.config.visitorCounts.title_count && XF.pageTitleCounterUpdate(a.total_unread), XF.config.visitorCounts.icon_indicator && XF.faviconUpdate(a.total_unread), b && (XF.CrossTab.trigger('visitorCounts', a), XF.LocalStorage.setJson('visitorCounts', {
        time: c || Math.floor((new Date).getTime() / 1000) - 1,
      ...
      if (b !== XF.favIconAlertShown) {
        ...
        if (c.length) {
          ...
          c.each(function (b, c) {
            ...
            e.shouldCountBeShown(a) ? (c || g.data('original-href', b), d('<img />').on('load', function () {
    ...
    ajax: function (a, b, c, e, f) {
      ...
      var p = function (a, b, c) {
        d(h).trigger('ajax:before-success', [
          a,
          b,
          c
        ]);
        l && XF.defaultAjaxSuccessError(a, b, c) || g && XF.defaultAjaxSuccess(a, b, c) || e && e(a, b, c)
      },
      t = function (a, b, c) {
        if (a.readyState) try {
      ...
      var w = k.FormData && c instanceof FormData;
      a = d.extend(!0, {
        cache: !0,
        data: c || {
        },
        ...
        complete: function (a, b) {
          d(h).trigger('ajax:complete', [
            a,
            b
          ])
        },
        timeout: 'get' === a ? 30000 : 60000,
        type: a,
        url: b,
        processData: w ? !1 : !0
      }, f);
    ...
    defaultAjaxSuccessError: function (a, b, c) {
      if ('object' != typeof a) return XF.alert('Response was not JSON.'),
      !0;
    ...
    defaultAjaxSuccess: function (a, b, c) {
      a && 'ok' == a.status && a.message && XF.flashMessage(a.message, 3000);
      return !1
    },
      ...
      if ('object' == typeof a && a.content) {
        ...
        XF.Loader.load(a.js, a.css, function () {
          ...
          if (m) {
            var h;
            l = d.trim(l);
            if (!p) for (; c = XF.scriptMatchRegex.exec(l); ) {
              var k = !1;
            ...
            l = l.replace(/<noscript>([\s\S]*?)<\/noscript>/gi, '')
          }
    ...
    applyDataOptions: function (a, b, c) {
      ...
      f;
      for (f in a) if (a.hasOwnProperty(f) && (e[f] = a[f], b.hasOwnProperty(f))) {
        var g = b[f];
        var l = typeof g;
        var m = !0;
        switch (typeof e[f]) {
      ...
      d.isPlainObject(c) && (e = d.extend(e, c));
      return e
    },
    ...
    autoFocusWithin: function (a, b, c) {
      ...
      e.length || (!e.length && XF.NavDeviceWatcher.isKeyboardNav() && (e = a.find('a, button, :input, [tabindex]').filter(':visible').not(':disabled, [data-no-auto-focus]')), e.length || (b = a.is('form:not([data-no-auto-focus])') ?
      a : a.find('form:not([data-no-auto-focus])').first(), b.length && (e = b.find(':input, button').filter(':visible').not(':disabled'))), !e.length && c && c.length && (e = c), e.length || (a.attr('tabindex', '-1'), e = a));
      a = [
      ];
      c = e[0].parentNode;
      do a.push({
    ...
    jsStates: {
      ...
      twitter: function () {
        k.twttr = function () {
          ...
          XF.loadScript('https://platform.twitter.com/widgets.js') && (a._e = [
          ], a.ready = function (b) {
            a._e.push(b)
          });
          return a
      ...
      imgur: function () {
        ...
        XF.loadScript('//s.imgur.com/min/embed-controller.js', function () {
          d(h).on('xf:reinit', function (a, b) {
            ...
            for (a = 0; a < imgurEmbed.tasks; a++) imgurEmbed.createIframe(),
            imgurEmbed.tasks--
          })
        });
        return !0
    ...
    requestAnimationTimeout: function (a, b) {
      function c() {
        Date.now() - f >= b ? a()  : g.id = d(c)
      }
      b || (b = 0);
      var d = k.requestAnimationFrame || function (a) {
        return k.setTimeout(a, 1000 / 60)
      },
      f = Date.now(),
      g = {
      };
    ...
    getLocalLoadTime: function () {
      ...
      f || (k.performance && k.performance.timing && 0 !== k.performance.timing.requestStart ? (f = k.performance.timing, f = Math.floor((f.requestStart + f.responseStart) / 2000))  : f = Math.floor((new Date).getTime() / 1000) - 1, b.val(f + ',' + a.now));
  ...
  XF.LocalStorage = {
    ...
    set: function (a, b, c) {
      try {
        k.localStorage.setItem(this.getKeyName(a), b)
      } catch (e) {
  ...
  XF.Breakpoint = function () {
    function a(a) {
      for (var b = 0; b < f.length && a != f[b]; b++) if (e == f[b]) return !0;
      return !1
    }
    function b(a) {
      for (var b = !1, c = 0; c < f.length; c++) if (a == f[c]) b = !0;
  ...
  XF.JobRunner = function () {
    ...
    p = function () {
      ...
      e--;
      0 > e && (e = 0);
      0 == e && (d(h).trigger('job:auto-blocking-complete'), x());
      f && f.abort();
      f = null
    },
    k = function () {
      ...
      runManual: function (c) {
        ...
        if (g) {
          ...
          if (!a) {
            ...
            l = function () {
              Array.isArray(e) && 0 == e.length ? k()  : f(e ? e.shift()  : null)
            };
            l()
          }
        }
  ...
  XF.ClassMapper = XF.create({
    ...
    extend: function (a, b) {
      ...
      c ? (c = XF.extend(c, b), this._map[a] = c)  : (this._toExtend[a] || (this._toExtend[a] = [
  ...
  XF.ActionIndicator = function () {
    ...
    c = function () {
      a++;
      1 == a && (b || (b = d('<span class="globalAction"><span class="globalAction-bar" /><span class="globalAction-block"><i></i><i></i><i></i></span></span>').appendTo('body')), b.addClassTransitioned('is-active'))
    },
    e = function () {
      a--;
  ...
  XF.DynamicDate = function () {
    ...
    k = function (m) {
      ...
      var p = m.length,
      h = Math.floor((new Date).getTime() / 1000) - a,
      k = new Date;
      k.setHours(0, 0, 0, 0);
      b + h > f && (k.getDay(), f = w(k, 1), c = w(k, 0), e = w(k, - 1), g = w(k, - 6));
      for (var t = 0; t < p; t++) {
        var n = m[t];
        var q = d(n);
        var v = parseInt(n.getAttribute('data-time'), 10);
        var y = b - v + h;
        var u = n.xfDynType;
        - 2 > y ? (y = v - (b + h), 60 > y ? 'futureMoment' != u && (q.text(XF.phrase('in_a_moment')), n.xfDynType = 'futureMoment')  : 120 > y ? 'futureMinute' != u && (q.text(XF.phrase('in_a_minute')), n.xfDynType = 'futureMinute')  : 3600 > y ? (v = Math.floor(y / 60), u !== 'futureMinutes' + v && (q.text(XF.phrase('in_x_minutes', {
          '{minutes}': v
        })), n.xfDynType = 'futureMinutes' + v))  : v < f ? 'latertoday' != u && (q.text(XF.phrase('later_today_at_x', {
          '{time}': q.attr('data-time-string')
        })), n.xfDynType = 'latertoday')  : v < w(k, 2) ? 'tomorrow' != u && (q.text(XF.phrase('tomorrow_at_x', {
          '{time}': q.attr('data-time-string')
        })), n.xfDynType = 'tomorrow')  : (604800 > y || (q.attr('data-full-date') ? q.text(XF.phrase('date_x_at_time_y', {
          '{date}': q.attr('data-date-string'),
          '{time}': q.attr('data-time-string')
        }))  : q.text(q.attr('data-date-string'))), n.xfDynType = 'future'))  : 60 >= y ? 'moment' !== u && (q.text(XF.phrase('a_moment_ago')), n.xfDynType = 'moment')  : 120 >= y ? 'minute' !== u && (q.text(XF.phrase('one_minute_ago')), n.xfDynType = 'minute')  : 3600 > y ? (v = Math.floor(y / 60), u !== 'minutes' + v && (q.text(XF.phrase('x_minutes_ago', {
          '{minutes}': v
        })), n.xfDynType = 'minutes' + v))  : v >= c ? 'today' !== u && (q.text(XF.phrase('today_at_x', {
          '{time}': q.attr('data-time-string')
        })), n.xfDynType = 'today')  : v >= e ? 'yesterday' !== u && (q.text(XF.phrase('yesterday_at_x', {
          '{time}': q.attr('data-time-string')
        })), n.xfDynType = 'yesterday')  : v >= g ? 'week' !== u && (q.text(XF.phrase('day_x_at_time_y', {
          '{day}': XF.phrase('day' + (new Date(1000 * v)).getDay()),
          '{time}': q.attr('data-time-string')
        })), n.xfDynType = 'week')  : 'old' !== u && (q.attr('data-full-date') ? q.text(XF.phrase('date_x_at_time_y', {
          '{date}': q.attr('data-date-string'),
          '{time}': q.attr('data-time-string')
        }))  : q.text(q.attr('data-date-string')), n.xfDynType = 'old')
      }
    },
    w = function (a, b) {
      return Math.floor((new Date(a.valueOf())).setFullYear(a.getFullYear(), a.getMonth(), a.getDate() + b) / 1000)
    };
    return {
      initialize: function () {
        if (!l) {
          l = !0;
          var t = XF.config.time;
          ...
          f = t.tomorrow;
          g = t.week;
          void 0 !== h.hidden ? (h.hidden || p(), d(h).on('visibilitychange', function () {
            h.hidden ? clearInterval(m)  : (p(), k(h))
          }))  : p()
        }
      },
      refresh: k
  ...
  XF.KeepAlive = function () {
    ...
    e,
    f = function () {
      var a = 3000 + (Math.floor(241 * Math.random()) + - 120);
      120 > a && (a = 120);
      e && clearInterval(e);
      e = setInterval(m, 1000 * a)
    },
    g = 0,
    l,
    m = function () {
      ...
      if (XF.config.enableRtnProtect && !a.isDefaultPrevented()) {
        ...
        if (c && (!c.match(/^[a-z]:/i) || c.match(/^https?:/i))) {
          ...
          if (!(b.closest('[contenteditable=true]').length || (c = XF.canonicalizeUrl(c), (new RegExp('^[a-z]+://' + location.host + '(/|$|:)', 'i')).test(c) || g && g == a.timeStamp || (b.data('blank-handler-last', a.timeStamp), l = navigator.userAgent, b = - 1 !== l.indexOf('MSIE'), g = - 1 !== l.indexOf('Safari') && - 1 == l.indexOf('Chrome'), l = - 1 !== l.indexOf('Gecko/'), a.shiftKey && l || g && (a.shiftKey || a.altKey) || b)))) {
            if (g) b = d('<iframe style="display: none" />').appendTo(h.body),
            g = b[0].contentDocument || b[0].contentWindow.document,
            g.__href = c,
            c = d('<script />', g),
            c[0].text = 'window.opener=null;window.parent=null;window.top=null;window.frameElement=null;window.open(document.__href).opener = null;',
            g.body.appendChild(c[0]),
            b.remove();
             else {
              c = k.open(c);
              try {
  ...
  XF.loadMultiBar = function (a, b, c, e) {
    ...
    if (c.cache && XF.loadMultiBar.cache[a]) f(XF.loadMultiBar.cache[a]);
      ...
      var g = function (b) {
        if (b.redirect) if (c.onRedirect) c.onRedirect(b, g);
  ...
  XF.loadOverlay = function (a, b, c) {
    ...
    if (b.cache && XF.loadOverlay.cache[a]) e(XF.loadOverlay.cache[a]);
      ...
      var f = function (d) {
        if (d.redirect) if (b.onRedirect) b.onRedirect(d, f);
  ...
  XF.ScrollButtons = function () {
    function a(a) {
      if (!t) {
        a = k.pageYOffset || h.documentElement.scrollTop;
        var c = x;
        x = a;
    ...
    w = !1,
    n = !1,
    x = k.pageYOffset || h.documentElement.scrollTop,
    r = null,
    B = null,
    A,
    z = null;
  ...
  XF.KeyboardShortcuts = function () {
    ...
    function b(a) {
      ...
      e = - 1 !== e.indexOf('META');
      (h = 0 + h ? 1 : 0 + k ? 2 : 0 + e ? 4 : 0) ? XF.Keyboard.isStandardKey(g) ? (f[g] = f[g] || {
      }, f[g][h] = a)  : console.warn('It is not possible to specify a keyboard shortcut using this key combination (%s)', b)  : f[c] = a
    }
    function c(a) {
      switch (a.key) {
        case 'Escape':
  ...
  function e(a) {
    ...
    return a.length ? (XF.NavDeviceWatcher.toggle(!0), a.is(XF.getKeyboardInputs()) ? a.autofocus()  : a.is('a[href]') ? a.get(0).click()  : a.click(), !0)  : !1
  }
  var f = {
  };
  return {
...
return {
  ...
  updateUserSubscription: function (a, b) {
    if ('update' !== b || !XF.Cookie.get('push_subscription_updated')) {
      ...
      e = a.getKey('auth'),
      f = (PushManager.supportedContentEncodings || [
        'aesgcm'
      ]) [0];
      d.ajax({
  ...
  d(a).find('.bbCodeBlock--expandable:not(.is-expanded)').each(function () {
    ...
    if (b) {
      ...
      l = function () {
        ...
        d = b.offsetHeight;
        0 == c || 0 == d ? 2000 < g || (f && (clearTimeout(f), g += 200), f = setTimeout(l, g))  : c > d + 1 ? a.addClass('is-expandable')  : a.removeClass('is-expandable')
      };
      l();
      if (!a.data('expand-check-triggered') && (a.data('expand-check-triggered', !0), a.find('img').one('load', l), k.MutationObserver)) {
        ...
        var w = new MutationObserver(function (b) {
          a.hasClass('is-expanded') ?
          w.disconnect()  : h && (m && clearTimeout(m), m = setTimeout(t, 200))
        });
        w.observe(this, {
          attributes: !0,
          childList: !0,
...
e = XF.create({
  ...
  _init: function () {
    ...
    ':after-init.' + this.eventNameSpace, [
      this,
      b
    ]));
    this.initialized = !0;
  ...
  _onEvent: function (a) {
    ...
    if (!b.isDefaultPrevented()) {
      if ('function' == typeof this[this.eventType]) b = this[this.eventType](a);
       ...
       else return console.error('You must provide a %1$s(e) method for your %1$s event handler', this.eventType, this.eventNameSpace),
      a.preventDefault(),
      !1;
      this.$target.trigger('xf-' + this.eventType + ':after-' + this.eventType + '.' + this.eventNameSpace, [
        this,
        b,
        a
      ])
...
showResults: function (a, b, c, e) {
  ...
  if (b) {
    ...
    for (f in b) if (b.hasOwnProperty(f)) {
      ...
      m.text = XF.htmlspecialchars(g.text),
      'undefined' !== typeof g.desc && (m.desc = XF.htmlspecialchars(g.desc)),
      'undefined' !== typeof g.icon ? m.icon = d('<img class="autoCompleteList-icon" />').attr('src', XF.htmlspecialchars(g.icon))  : 'undefined' !== typeof g.iconHtml && (m.icon = d('<span class="autoCompleteList-icon" />').html(g.iconHtml)),
      m.icon && (m.icon = m.icon[0].outerHTML);
      l.data('insert-text', p);
    ...
    if (this.$results.children().length) {
      ...
      (b = c.parents().filter(function () {
        ...
        t.css(w(e))
      }), this.$scrollWatchers = b); this.$results.css(w(e)).show(); this.resultsVisible = !0
    }
...
insertSelectedResult: function () {
  ...
  0 <= this.selectedResult && (a = this.$results.children().get(this.selectedResult)) && (b = this.getResultText(a), this.options.beforeInsert && (b = this.options.beforeInsert(b, a)), this.insertResult(b), b = !0);
  this.hideResults();
  return b
},
...
keydown: function (a) {
  if (this.visible) switch (a.which) {
    ...
    case 27:
      ...
      !1;
    case 13:
      if (this.visible) return this.results.insertSelectedResult(),
      a.preventDefault(),
      !1
  }
},
...
getCurrentMatchInfo: function () {
  ...
  if (0 === d || b.substr(d - 1, 1).match(/(\s|[\](,]|--)/)) {
    var f = b.substr(d + 1);
    if (!f.match(/\s/) || 15 >= f.length) return {
      text: b,
      textNode: c,
      start: d,
...
insertResult: function (a) {
  ...
  if (b) {
    ...
    g.autofocus(),
    - 1 !== c && (g.setSelection(b.start, e.end), g.replaceSelectedText((this.options.keepAt ? this.options.at : '') + a + ' ', 'collapseToEnd'))
  }
},
show: function (a, b) {
  ...
  if (c) if (this.visible = !0, this.ed) {
    ...
    for (var b = d('<div />'), l = k.getComputedStyle(e[0]), m, n = '', x = 0; x < l.length; x++) m = l[x],
    n += m + ': ' + l.getPropertyValue(m) + '; ';
    b[0].style.cssText = n;
    b.css({
      position: 'absolute',
      height: '',
...
click: function (a) {
  ...
  if (d.length) {
    try {
      var f = d.offset().top;
      'pushState' in e.history && e.history.pushState({
      }, '', e.location.toString().replace(/#.*$/, '') + b);
      c('html, body').animate({
        scrollTop: f
...
init: function () {
  ...
  if (a) if (this.href = a, this.getCurrentContainer()) this.$form.on('preview:hide', XF.proxy(this, 'onPreviewHide'));
...
onLoad: function (a) {
  if (a.html) {
    ...
    a.html.content ? XF.setupHtmlInsert(a.html, function (a, c, e) {
...
if (b.switchKey) {
  ...
  if (f) {
    for (var e, g; e = f.match(/(\s*,)?\s*(addClass|removeClass):([^,]+)(,|$)/); ) if (f = f.substring(e[0].length), g = c.trim(e[3]), g.length) switch (e[2]) {
      case 'addClass':
        a.addClass(g);
        break;
      case 'removeClass':
...
if (b.message) {
  var h = d && b.redirect;
  XF.flashMessage(b.message, h ? 1000 : 3000, function () {
...
init: function () {
  ...
  if (!a || !a.length) if (d && d.length && '#' == d.charAt(0)) a = c(d);
   else if (this.options.silent) return;
  if (a && a.length) if (this.$scroll = a, !0 === b || 'true' === b) a = a.attr('id'),
...
init: function () {
  if (this.options.draftUrl) {
    ...
    setInterval(XF.proxy(this, 'triggerSave'), 1000 * this.options.draftAutosave)
...
init: function () {
  ...
  if (this.options.previewUrl) if (b.length) b.on({
...
focus: function (a) {
  ...
  if (!b.attr('href')) {
    ...
    var d = b.data('href');
    if (d) d = d.replace('{url}', encodeURIComponent(this.pageUrl)).replace('{title}', encodeURIComponent(this.pageTitle)),
    b.attr('href', d);
      ...
      this.clipboard = new Clipboard(b[0], {
        text: function (a) {
          return c(a).data('clipboard').replace('{url}', f.pageUrl).replace('{title}', f.pageTitle)
        }
      });
...
linkClick: function (a) {
  ...
  this.setDismissCookie(!0, 43200000);
...
setDismissCookie: function (a, b) {
  a ? (b || (b = 315360000000), XF.Cookie.set('push_notice_dismiss', '1', new Date(Date.now() + b)))  : XF.Cookie.set('push_notice_dismiss', '1')
},
...
click: function (a) {
  if (!(0 < a.button || a.ctrlKey || a.shiftKey || a.metaKey || a.altKey)) if (a.preventDefault(), this.clickE = a, this.$target.hasClass('is-bookmarked')) this.trigger.clickShow(a);
...
submit: function (a) {
  ...
  if (!(this.$submitButton && this.$submitButton.data('prevent-ajax') || XF.debug.disableAjaxSubmit)) if (this.submitPending) a && a.preventDefault();
   else {
    var k = {
      skipDefault: !0
    };
...
submitResponse: function (a, b, e) {
  if ('object' != typeof a) XF.alert('Response was not JSON.');
    ...
    if (!f.isDefaultPrevented()) {
      ...
      if (a.errorHtml) b.trigger(f, a, this),
      f.isDefaultPrevented() || XF.setupHtmlInsert(a.errorHtml, function (a, b) {
        b = b.h1 || b.title || XF.phrase('oops_we_ran_into_some_problems');
        XF.overlayMessage(b, a)
      }),
      k = !0;
       else if (a.errors) b.trigger(f, a, this),
      f.isDefaultPrevented() || XF.alert(a.errors),
      k = !0;
       else if (a.exception) XF.alert(a.exception);
       else if ('ok' == a.status && a.message) h ? this.options.forceFlashMessage ? XF.flashMessage(a.message, 1000, function () {
        XF.redirect(a.redirect)
      })  : XF.redirect(a.redirect)  : XF.flashMessage(a.message, 3000),
...
doSubmitReplace: function (a, b) {
  ...
  if ('self' == e || this.$target.is(e)) var d = this.$target;
   else d = this.$target.find(e).first(),
  d.length || (d = c(e).first());
  if (!d.length) return console.error('Could not find old selector \'' + e + '\''),
  !1;
  var h = a.is(f) ? a : a.find(f).first();
  if (!h.length) return console.error('Could not find new selector \'' + f + '\''),
  !1;
...
setActive: function (a) {
  ...
  this.deployMultiBar();
  this.isActive != b && (this.debug('setActive: %s', this.isActive), this.$target.trigger(this.isActive ? 'selectplus:activate' : 'selectplus:deactivate', [
    this
  ]).toggleClassTransitioned(this.options.activeClass, this.isActive), c(d.body).toggleClassTransitioned('is-spDocTriggered', this.isActive))
},
redrawSelected: function () {
  this.$target.trigger('selectplus:redraw-selected', [
    this
  ]);
  var a = this;
  this.$checkboxes.each(function (b) {
    ...
    e.data('check-state') != f && b.trigger('selectplus:toggle-item', [
      this,
      f
    ]);
...
redrawHover: function () {
  this.$target.trigger('selectplus:redraw-hover', [
    this
  ]);
...
init: function () {
  ...
  this.$target.on('keypress change paste input', function (b) {
    c(b.target).prop('readonly') || a.cloned || (a.cloned = !0, a.$target.off(b), a.create())
  })
},
create: function () {
  if (!this.created && (this.created = !0, 0 != this.options.remaining)) {
    ...
    if (this.options.incrementFormat) {
      var e = new RegExp(b + XF.regexQuote(a).replace('\\{counter\\}', '(\\d+)'));
      this.$clone.find('input, select, textarea').each(function () {
        var b = c(this),
        d = b.attr('name');
        d = d.replace(e, function (b, c) {
...
update: function () {
  ...
  if (a < this.options.minWindowHeight) 'normal' != this.state && (this.resetTarget(), this.state = 'normal');
    ...
    if (a >= this.elBottom) 'normal' != this.state && (this.resetTarget(), this.state = 'normal');
      ...
      a <= d ? d >= this.elBottom || 'absolute' == this.state || (a = this.$container.offset(), 'stuck' == this.state ? (b = this.$fixEl.parent(), 'static' == b.css('position') && (b = b.offsetParent()))  : b = this.$fixEl.offsetParent(), b = b.offset(), this.$fixEl.css({
        position: 'absolute',
...
update: function () {
  this.initialized ? autosize.update(this.$target[0])  :
  this.setupDelayed()
},
...
init: function () {
  null ===
  this.options.editUrl ? console.warn('TextEdit must specify data-edit-url')  : (this.options.escapeRevert && (this.$target.data('original-text', this.$target.val()), this.$target.onPassive('keyup', XF.proxy(this, 'keyEscape'))), this.$target.on('change', XF.proxy(this, 'save')))
},
focus: function (a) {
},
save: function (a) {
...
stepFallback: function (a) {
  if (!this.$textInput.prop('readonly')) {
    ...
    if (Math.round(d) !== d) {
      var m = 0;
      c = c.split('.');
      l ? m = c[1] ? c[1].length : 0 : Math.floor(h) !== h && (m = h.toString().split('.') [1].length || 0);
      d = d.toFixed(m)
    }
    null !== a && d < a && (d = a);
    null !== g && d > g && (d = g);
...
$checkboxes: null,
init: function () {
  (this.$select = XF.findRelativeIf(this.options.select, this.$target)) && this.$select.length ? (this.$checkboxes = this.$target.find(':checkbox').on('click', XF.proxy(this, 'update')), this.update())  : console.warn('No select element found using %s', this.options.select)
},
update: function () {
  var a = this.$select;
...
XF.Element.register('changed-field-notifier', 'XF.ChangedFieldNotifier'); XF.Element.register('check-all', 'XF.CheckAll'); XF.Element.register('select-plus', 'XF.SelectPlus'); XF.Element.register('date-input', 'XF.DateInput'); XF.Element.register('desc-loader', 'XF.DescLoader'); XF.Element.register('disabler', 'XF.Disabler'); XF.Element.register('field-adder', 'XF.FieldAdder'); XF.Element.register('form-submit-row', 'XF.FormSubmitRow'); XF.Element.register('guest-username', 'XF.GuestUsername'); XF.Element.register('min-length', 'XF.MinLength'); XF.Element.register('textarea-handler', 'XF.TextAreaHandler'); XF.Element.register('permission-matrix', 'XF.PermissionMatrix'); XF.Element.register('number-box', 'XF.NumberBox'); XF.Element.register('checkbox-select-disabler', 'XF.CheckboxSelectDisabler'); XF.Element.register('password-hide-show', 'XF.PasswordHideShow'); XF.Element.register('change-submit', 'XF.ChangeSubmit')
}(jQuery, window, document);
var $jscomp = $jscomp || {
}; $jscomp.scope = {
...
}; $jscomp.ASSUME_ES5 = !1; $jscomp.ASSUME_NO_NATIVE_MAP = !1; $jscomp.ASSUME_NO_NATIVE_SET = !1; $jscomp.defineProperty = $jscomp.ASSUME_ES5 || 'function' == typeof Object.defineProperties ? Object.defineProperty : function (d, h, k) {
d != Array.prototype && d != Object.prototype && (d[h] = k.value)
};
$jscomp.getGlobal = function (d) {
return 'undefined' != typeof window && window === d ? d : 'undefined' != typeof global && null != global ? global : d
}; $jscomp.global = $jscomp.getGlobal(this); $jscomp.polyfill = function (d, h, k, a) {
if (h) {
k = $jscomp.global;
d = d.split('.');
for (a = 0; a < d.length - 1; a++) {
...
onEvent: function (a) {
  ...
  if (!this.loading) {
    ...
    var b = this;
    XF.ajax('get', this.href, {
    }, XF.proxy(this, 'onLoad')).always(function () {
      b.loading = !1
    })
  }
},
onLoad: function (a) {
  if (a.html) {
    ...
    XF.setupHtmlInsert(a.html, function (a, e, d) {
      ...
      b._applyChange(a, c.before, XF.proxy(b, '_applyBefore'));
...
_applyChange: function (a, b, c) {
  if (b && b.length) {
    b = b.split(',');
    for (var e, f, g, h = 0; h < b.length; h++) e = b[h].split(' with '),
    f = d.trim(e[0]),
    g = e[1] ? d.trim(e[1])  : f,
    f.length && g.length && (e = d(f).first(), g = a.is(g) ? a : a.find(g).first(), c(f, e, g))
  }
},
...
init: function () {
  ...
  if (this.$menu.length) {
    ...
    if (a = this.$menu.data('menu-builder')) if (XF.MenuBuilder[a]) XF.MenuBuilder[a](this.$menu, this.$target, this);
...
open: function (a) {
  ...
  if (!this.isOpen() && !b.hasClass('is-disabled')) {
    ...
    this.$target.trigger('menu:opened', [
      b
    ]);
      ...
      if (!b.data('menu-loading')) {
        ...
        XF.ajax('get', b.data('href'), {
          ...
          a.html && XF.setupHtmlInsert(a.html, function (a, c, e) {
            ...
            g.$target.trigger('menu:complete', [
              b
            ]);
    ...
    } else this.$target.trigger('menu:complete', [
      b
    ]),
    b.trigger('menu:complete')
  }
...
close: function () {
  if (this.isOpen()) {
    ...
    this.$target.trigger('menu:closed', [
      a
    ]);
...
init: function () {
  ...
  if (this.$menu.length) {
    ...
    if (a) if (XF.OffCanvasBuilder[a]) XF.OffCanvasBuilder[a](this.$menu, this);
...
navigation: function (a, b) {
  ...
  d('.js-offCanvasNavSource .p-navEl').each(function () {
    ...
    h = a.find('[data-menu]');
    a.data('has-children') && !h.length && (a = a.find('[data-xf-click~="menu"]').first().data('xf-click-handlers')) && a.menu && (h = a.menu.$menu);
    if (g.length) {
...
show: function () {
  if (this.overlay) this.overlay.show();
    ...
    this.options.followRedirects && (b.onRedirect = function (b, e) {
      a.options.forceFlashMessage ? XF.flashMessage(b.message, 1000, function () {
...
load: function () {
  ...
  a && !this.loading && (this.loading = !0, XF.ajax('get', a, function (a) {
    a.html && XF.setupHtmlInsert(a.html, function (a, c, d) {
      if (c = b.$toggleTarget.data('load-selector')) c = a.find(c).first(),
      c.length && (a = c);
      b.ajaxLoaded = !0;
...
show: function (a) {
  if (!this.isVisible() && !this.isTransitioning() && !this.getOtherToggles().filter('.is-transitioning').length) if (this.toggleUrl && !this.ajaxLoaded) this.load();
   else {
    this.closeOthers();
    var b = this.options.activeClass;
...
get: function (a, b, c) {
  ...
  d = d[b];
  var g = Math.floor(Date.now() / 1000);
  if (!e && d[0] + d[1] < g) return delete this.dataCache[a][b],
  this.scheduleSync(a),
  null;
...
init: function () {
  ...
  if (a.length) {
    ...
    this.$goEnd = d('<i class="' + f + ' ' + f + '--end" aria-hidden="true" />').click(function () {
      e.step(1)
    }).insertAfter(a);
    this.updateScroll();
    ...
    if (l.length) {
      ...
      m = m.left;
      l = m + l;
      XF.isRtl() ? 80 > m && a.normalizedScrollLeft( - l + f - 50)  : l > f && (l + 80 > f ? a.normalizedScrollLeft(m - 50)  : a.normalizedScrollLeft(m - 80))
    }
...
init: function () {
  ...
  this.stickyBroken = b;
  this.update();
  d(h).on('resize.sticky-header', XF.proxy(this, 'update'))
},
update: function () {
...
_enable: function () {
  ...
  if (this.supportsSticky) {
    ...
    m = function (c) {
      ...
      d < f || d == f && 0 < h.scrollY ? e || (a.addClass(b), e = !0)  : e && (g && c ? (clearTimeout(k), k = setTimeout(function () {
        m(!1)
...
init: function () {
  ...
  this.$panes = a;
  if (b.length != a.length) console.error('Tabs and panes contain different totals: %d tabs, %d panes', b.length, a.length),
...
onPopState: function (a) {
  (a = a.originalEvent.state) && a.id ? this.activateTarget('#' +
  a.id, !1)  : a && a.offset ? this.activateTab(a.offset)  : this.activateTab(this.initial)
},
...
activateTab: function (a) {
  ...
  b.length && c.length ? (this.$tabs.filter('.' + d).removeClass(d).attr('aria-selected', 'false').trigger('tab:hidden'), this.$panes.filter('.' +
  d).removeClass(d).attr('aria-expanded', 'false').trigger('tab:hidden'), b.addClass(d).attr('aria-selected', 'true').trigger('tab:shown'), c.addClass(d).attr('aria-expanded', 'true').trigger('tab:shown'), XF.layoutChange(), c.data('href') && !c.data('tab-loading') && (c.data('tab-loading', !0), XF.ajax('get', c.data('href'), {
  }, function (a) {
    c.data('href', !1);
    if (a.html) {
...
}; $jscomp.ASSUME_ES5 = !1; $jscomp.ASSUME_NO_NATIVE_MAP = !1; $jscomp.ASSUME_NO_NATIVE_SET = !1; $jscomp.defineProperty = $jscomp.ASSUME_ES5 || 'function' == typeof Object.defineProperties ? Object.defineProperty : function (d, k, e) {
d != Array.prototype && d != Object.prototype && (d[k] = e.value)
};
$jscomp.getGlobal = function (d) {
return 'undefined' != typeof window && window === d ? d : 'undefined' != typeof global && null != global ? global : d
}; $jscomp.global = $jscomp.getGlobal(this); $jscomp.polyfill = function (d, k, e, a) {
if (k) {
e = $jscomp.global;
d = d.split('.');
for (a = 0; a < d.length - 1; a++) {
...
show: function () {
  if (!this.shown) if (this.shown = !0, this.loadRequired) this.loadContent();
   else {
...
reposition: function () {
  ...
  if (!a) console.error('No tooltip positioner');
    ...
    b = c = 0;
    n = a.find('.' + n + '-arrow');
    if ('left' == g || 'right' == g) l.top < f.top ? c = f.top - l.top : l.bottom > f.bottom && (c = f.bottom - l.bottom),
    n.css({
      left: '',
      top: 50 - 100 * c / l.top + '%'
    });
...
for (var m = this.options.trigger.split(' '), f = 0; f < m.length; f++) switch (m[f]) {
  ...
  case 'click':
    ...
    a.onPointer('auxclick.tooltip contextmenu.tooltip', function () {
      d.cancelShow();
      d.stopFocusBefore = Date.now() + 2000
    });
    break;
  case 'touchclick':
    c = !0;
...
if (!b && this.options.clickHide) a.onPointer('click.tooltip auxclick.tooltip contextmenu.tooltip', function (a) {
  c && XF.isEventTouchTriggered(a) || (d.hide(), d.stopFocusBefore = Date.now() + 2000)
});
a.on({
...
a = d();
for (var c, g = 0; g < b.length; g++) c = d('<div class="tooltipCover" />').css(b[g]),
a = a.add(c);
...
var b = this;
XF.ajax('get', this.options.previewUrl, {
}, function (c) {
  b.loaded(c, a)
}, {
  skipDefault: !0,
...
this.trigger.wasClickTriggered() && (c.global = !0);
XF.ajax('get', this.$target.data('href'), {
}, function (c) {
  b.loaded(c, a)
}, c)
},
